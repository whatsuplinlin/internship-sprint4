...
function showMenu() {
  if (navItems.value.style.display === "block") {
    navItems.value.style.display = "none";
  } else {
    navItems.value.style.display = "block";
  }
}
</script>
